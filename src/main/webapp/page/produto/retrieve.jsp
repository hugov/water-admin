			...
			<form action="index.html">
				...
				<div class="row">
					<div class="form-group col-md-4">
    					...
    					<p><s:if test="produto.situacao == 1">Ativo</s:if><s:else>Inativo</s:else></p>
					</div>
				</div>
				...
				<div id="actions" class="row">
					<div class="col-md-12">
						<a href="produtoList.action" class="btn btn-primary">Voltar</a>
						<a href="produtoUpdate.action?submitType=updatedata&id=<s:property value="produto.id" />" class="btn btn-default">Editar</a>
