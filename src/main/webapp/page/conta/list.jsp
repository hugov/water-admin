	...
	<body>
		...
		<script lang="javascript">
			...
			function defineId(param) {
				var contaEl = document.querySelector('button#contaId');
				contaEl.setAttribute('onclick', 'sendFormDelete(' + param + ')');
			}
		
			function sendFormDelete(id) {
			    $.ajax({
			        url: "contaDelete.action",
			        type: "POST",
			        data: {'id': id},
			    	success: function() {
			    		location = 'contaList.action';
			        	location.load();
			    	}
			    });
			}
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-primary" id="contaId" onClick="sendFormDelete(<s:property value="id" />);">Sim</button>
		...
		<div id="main" class="container-fluid">
			...
			<div id="top" class="row">
				...
				<div class="col-md-6">
					<div class="input-group h2">
						<input name="data[search]" class="form-control" id="search"
							type="text" placeholder="Pesquisar Contas"> <span
				...
				<div class="col-md-3">
					<a href="page/conta/create.jsp" class="btn btn-primary pull-right h2">Adicionar Conta</a>
				</div>
			</div>
				...
				<div class="table-responsive col-md-12">
					<table class="table table-striped" cellspacing="0" cellpadding="0">
						...
						<tbody>
							...
							<s:iterator value="contaList" status="conta">
							<tr>
								...
								<td class="actions">
									<a class="btn btn-success btn-xs" href="contaRetrieve.action?id=<s:property value="id" />">Visualizar</a> 
									<a class="btn btn-warning btn-xs" href="contaUpdate.action?submitType=updatedata&id=<s:property value="id" />">Editar</a> 
