	...
	<body>
		...
		<div id="main" class="container-fluid">
			...
			<div id="top" class="row">
				...
				<div class="col-md-6">
					<div class="input-group h2">
						<input name="data[search]" class="form-control" id="search"
							type="text" placeholder="Pesquisar Entregadors"> <span
				...
				<div class="col-md-3">
					<a href="page/entregador/create.jsp" class="btn btn-primary pull-right h2">Adicionar Entregador</a>
				</div>
			</div>
				...
				<div class="table-responsive col-md-12">
					<table class="table table-striped" cellspacing="0" cellpadding="0">
						...
						<tbody>
							...
							<s:iterator value="entregadorList" status="entregador">
							<tr>
								...
								<td class="actions">
									<a class="btn btn-success btn-xs" href="entregadorRetrieve.action?id=<s:property value="id" />">Visualizar</a> 
									<a class="btn btn-warning btn-xs" href="entregadorUpdate.action?submitType=updatedata&id=<s:property value="id" />">Editar</a> 
