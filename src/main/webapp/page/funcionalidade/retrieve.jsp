...
<html lang="pt-br">
	...
	<body>
		...
		<div id="main" class="container-fluid">
 			<h3 class="page-header">Visualizar Funcionalidade</h3>
			...
			<form action="index.html">
				...
				<div class="row">
					<div class="form-group col-md-4">
    					...
    					<p><s:if test="funcionalidade.situacao == 1">Ativo</s:if><s:else>Inativo</s:else></p>
					</div>
				</div>
				...
				<div id="actions" class="row">
					<div class="col-md-12">
						<a href="funcionalidadeList.action" class="btn btn-primary">Voltar</a>
						<a href="funcionalidadeUpdate.action?submitType=updatedata&id=<s:property value="funcionalidade.id" />" class="btn btn-default">Editar</a>
