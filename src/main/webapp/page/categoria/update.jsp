...
<html lang="pt-br">
	...
	<body>
		...
		<div id="main" class="container-fluid">
 			<h3 class="page-header">Atualizar Categoria</h3>

			<form action="/water-admin/categoriaUpdate.action">
				...
				<div class="row">
					<div class="form-group col-md-4">
						...
						<input type="text" class="form-control" name="categoria.descricao" value="${categoria.descricao}">
					</div>
				</div>
				...
				<div class="row">
					<div class="form-group col-md-4">
						...
						<select name="categoria.situacao" class="form-control">
							...
							<option value="1" <s:if test="categoria.situacao == 1">selected</s:if> >Ativo</option>
							<option value="0" <s:if test="categoria.situacao == 0">selected</s:if> >Inativo</option>
						</select>
					</div>
				</div>
